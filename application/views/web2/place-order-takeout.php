						...
						<div class="col-md-6">
                            <div class="delivery-address d-flex justify-content-around">
                                <div class="form-check deliver-now">
                                    ...
                                    <label class="form-check-label" for="deliverOption1">Takeout</label>
                                </div>
                                <div class="form-check deliver-later">
                                    ...
                                    <label class="form-check-label" for="deliverOption2">Takeout Later</label>
                                </div>
                            </div>
                            <div class="select-time">   
                                ...
                                <div class="select-instead">
                                    <div class="md-form text-center">
                                       <a href="<?php echo BASE_URL(); ?>web/home/place_order">Deliver Instead</a>
                                    </div>
                                </div>
                            </div>
