						...
						<div class="col-md-6">
							<div class="delivery-address d-flex justify-content-around">
								<div class="form-check deliver-now">
									<input class="form-check-input" type="radio" name="deliveroption" id="deliverOption1" value="office" checked>
									<label class="form-check-label" for="deliverOption1">Weekly Planner</label>
								</div>
							...
							<div class="select-time">
								<div class="md-form text-center">
									...
									<input placeholder="00:00" type="text" id="input_starttime" class="form-control timepicker">
								</div>
							</div>
						</div>
					</div>
				...
				<div class="confirm-order">
					...
					<form name="payment-method" class="payment-method" id="paymentMethod">
							...
							<div class="col-md-6">
								<div class="confirm-order-detail">
                                    <div class="header row m-0">
                                        ...
                                        <div class="header-title rate-txt col-3 col-md-3 p-0">Rate</div>
						...
						<div class="form-actions d-flex justify-content-between">
							<input type="button" name="backtocart" class="white-btn backtocart-btn" id="backtocart" value="Back to cart" onclick="location.href = 'cart.html';">
							<input type="button" name="placeorder" class="small-red-btn placeorder-btn" id="placeorder" value="Place order">
						</div>
					</form>
				</div>
			</div>
