 ...
 <!-- Start content -->
 <?php
 $post_link = base_url().'vender-request-save';
 ?>
<div class="content">
        ...
        <div class="row">
            ...
            <div class="col-lg-10">
                <div class="page-title-box">
                    <h4 class="page-title">Edit Restaurant Request</h4>
                </div>
            </div>
            <div class="col-lg-1">
            </div>
    ...
    ?>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label for="message">Message From Owner</label>
                                        <div>
                                            <?php
    $field_value = NULL;
    ...
    if (isset($temp_value) && !empty($temp_value)) {
        ...
        $field_value = $vender_detail->message;
    }
    ?>
                                            <textarea readonly class="form-control" id="message" rows="3"><?php echo $vender_detail->message; ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    if (isset($temp_value) && !empty($temp_value)) {
        ...
        $field_value = $vender_detail->contact_no;
    }
    ?>
    ...
    ?>
                            ...
                            <input type="hidden" name="request_id" value="<?php echo $vender_detail->id ?>">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group m-b-0">
                                        <div>
                                            ...
                                            <a href="<?php echo base_url().'vender-requests'; ?>" class="btn btn-secondary waves-effect m-l-5">
                                                Cancel
                                            </a>
                                        </div>
                                    </div>
