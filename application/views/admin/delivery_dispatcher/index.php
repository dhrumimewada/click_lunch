        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    <h4 class="page-title">Delivery Dispatcher</h4>
                    <div class="state-information d-none d-sm-block">
                        <a class="btn btn-primary waves-effect waves-light btn-bg" href="<?php echo base_url().'delivery-dispatcher-add'; ?>">Add Delivery Dispatcher</a>
                    </div>
                </div>
                <?php echo get_msg(); ?>
            </div>
        ...
        <div class="row" id="customer-list">
            <div class="col-12">
                <div class="card m-b-20">
                    <div class="card-body">
                        <table class="table table-hover dt-responsive nowrap delivery_dispatcher_list" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            <thead>
                            <tr>
                                <th>Id</th>
                                <th>Full Name</th>
...
<script type="text/javascript">
    ...
    var delete_url = "<?php echo base_url().'delivery-dispatcher-delete'; ?>";
    var status_url = "<?php echo base_url().'delivery-dispatcher-status'; ?>";
                    ...
                    $.ajax({
                        ...
                        success: function (returnData) {
                            ...
                            if (typeof returnData != "undefined")
                            {
                                swal(
                                    'Deleted!',
                                    'Delivery dispatcher has been deleted.',
                                    'success'
                                )
                                remove_row($this);
                            } 
                    ...
                    $.ajax({
                        ...
                        success: function (returnData) {
                            ...
                            if (typeof returnData != "undefined")
                            {
                                swal(
                                    change_status_to1,
                                    'Delivery dispatcher has been '+change_status_to1,
                                    'success'
                                )
