...
<div class="content">
    ...
    ?>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="required" for="autocomplete">Preferred City</label>
                                        <div>
                                            <?php
    $field_value = NULL;
    ...
    ?>
                                            <input id="autocomplete" placeholder="Enter city" onFocus="geolocate()" class="form-control" type="text" value="<?php echo $field_value; ?>" name="address" >
