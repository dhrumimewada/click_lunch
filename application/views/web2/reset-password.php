                              ...
                              <form class="reset-form" id="reset-form">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">                                          
                                            <input type="password" class="form-control" id="email" placeholder="Old-password">
                                        </div>
                                         <div class="form-group">                                          
                                ...
                                <div class="row">                                   
                                    <div class="col-sm-6 reset-btn">
                                        <input type="submit" name="register" class="register small-red-btn" id="pass-submit-btn" value="Submit">
                                    </div>
                                </div>                        
                            </form>
                            </div>
