...
<?php
$put_link = base_url().'custom-push-restaurant';
?>
<div class="content">
        ...
        <div class="row">
            ...
            <div class="col-lg-10">
                <div class="page-title-box">
                    <h4 class="page-title">Send notification to Restaurant(s)</h4>
                </div>
            </div>
            <div class="col-lg-1">
            </div>
...
?>
                                        <select class="select2 form-control" data-placeholder="Select restaurant(s)" name="shop[]" id="shop" multiple>
                                                <?php 
