                    ...
                    $.ajax({
                        ...
                        success: function (returnData) {
                            ...
                            if (typeof returnData != "undefined")
                            {
                                ...
                                $this.replaceWith("<button type='button' class='btn btn-outline-primary waves-effect waves-light deactive_shop' status-id='" +status+ "' title='"+btn_name_replace+"' data-popup='tooltip'>" +btn_name_replace+ "</button>");
