                                            ...
                                            <table class="table">
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        echo '</span>';
                                                        $item_total_amount = $total_price * $value['quantity'];
                                                        $sub_total += $item_total_amount;
                                                        ?>
                                                    </td>

                                                    <td class="text-center">$<?php echo number_format((float)$total_price, 2, '.', ''); ?></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="no-line text-right">
                                                        <?php 
                                                        $tax_amount = ($order_data['order']->tax > 0)?(floatval($sub_total) / 100) * floatval($order_data['order']->tax):0;
                                                        ?>
                                                        <strong>TAX (<?php echo $order_data['order']->tax; ?>%)</strong></td>
                                                    <td class="no-line text-right">$<?php echo number_format((float)$tax_amount, 2, '.', ''); ?></td>
                                                </tr>
                                                <tr>
                                                    <td class="no-line"></td>
                                                    <td class="no-line"></td>
                                                    <td class="no-line text-right">
                                                        <?php 
                                                        $service_charge_amount = ($order_data['order']->service_charge > 0)?(floatval($sub_total) / 100) * floatval($order_data['order']->service_charge):0;
                                                        ?>
                                                        <strong>Service Charge (<?php echo $order_data['order']->service_charge; ?>%)</strong></td>
                                                    <td class="no-line text-right">$<?php echo number_format((float)$service_charge_amount, 2, '.', ''); ?></td>
                                                </tr>
                                                <tr>
                                                    <td class="no-line"></td>
                                                    <td class="no-line"></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="no-line text-right">
                                                        ...
                                                        <?php
                                                        $total = ($sub_total - $promo_amount) + $order_data['order']->delivery_charges + $tax_amount + $service_charge_amount;
                                                        ?>
