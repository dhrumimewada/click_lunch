...
$push_to_delivery_boy_link = base_url().'custom-push-deliveryboy';
                    ...
                    <div class="state-information d-none d-sm-block">
                        ...
                        <div class="btn-group ml-1 mo-mb-2">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <a class="dropdown-item" href="<?php echo $push_to_delivery_boy_link; ?>">Notification to DeliveryBoys</a>
                            </div>
                        </div>
                    </div>
                </div>
