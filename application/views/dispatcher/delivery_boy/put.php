 <!-- Start content -->
<?php
$put_link = base_url().'delivery-boy-update/'.$id;
...
<div class="content">
        ...
        <div class="row">
            ...
            <div class="col-lg-10">
                <div class="page-title-box">
                    <h4 class="page-title">Update Delivery Boy</h4>
                </div>
            </div>
            <div class="col-lg-1">
            </div>
    ...
    if (isset($temp_value) && !empty($temp_value)) {
        ...
        $field_value = stripslashes($delivery_boy_detail->username);
    }
    ?>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label>Email</label>
                                        <div>
                                            <input type="text" name="email" class="form-control" id="email" placeholder="Enter email" value="<?php echo $delivery_boy_detail->email; ?>" disabled>
                                        </div>
                                    </div>
                                </div>
                            </div>
